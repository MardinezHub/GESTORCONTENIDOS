...
<head>
  ...
  <title>Administrar Listas - Administrador</title>
  <!-- Favicons -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="../../Controller/listaController.php" method="POST">
                  ...
                  <input type="hidden" name="accion" value="registrarlista">
          ...
          <div class="card">
              <div class="card-body">
                  ...
                  <form class="row g-3" action="../../Controller/listaController.php" method="POST">
                      ...
                      <input type="hidden" name="accion" value="registraropcion">
                      <div class="text-center">
    ...
    <div class="modal-dialog modal-lg-4">
      <div class="modal-content">
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data" action="../../Controller/listaController.php">
            ...
            <input type="hidden" name="accion" value="updatelista">
            <div class="text-center">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editForm" method="POST" enctype="multipart/form-data" action="../../Controller/listaController.php">
            ...
            <input type="hidden" name="accion" value="updateopcion">
            <div class="text-center">
