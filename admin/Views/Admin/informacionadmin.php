...
<head>
  ...
  <title>Administrar Información - Administrador</title>
  <!-- Favicons -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="../../Controller/informacionController.php" method="POST">
                  ...
                  <input type="hidden" name="accion" value="registrarinformacion">
      ...
      <div class="modal-content">
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data" action="../../Controller/informacionController.php">
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="accion" value="updateinformacion">
            <div class="text-center">
