<?php
  ...
  $noticia = $noticiaModel->ListarNoticia();
...
<head>
  ...
  <title>Noticia - Administrador</title>
  <!-- Favicons -->
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <center>
      <h1>Gestor de Contenidos - Noticias</h1>
      </center>
    </div>
    <section class="section dashboard">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <form class="row g-3" action="../../Controller/noticiaController.php" method="POST" enctype="multipart/form-data">
                <div class="col-12">
                    <br/>
                ...
                <div class="col-12">
                    <label for="filenoticia" class="form-label">Foto de la Noticia:</label>
                    <input type="file" id="filenoticia" name="filenoticia" class="form-control" />
                </div>
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tabla de Noticia</h5>
              ...
              <table class="table" id="table_id">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Foto de la Noticia</th>
                ...
                <?php if($noticia): ?>
                  ...
                  <tr class="align-middle">
                    ...
                    <td scope="row"><?php echo htmlspecialchars($row['descripcion']); ?></td>
                    <td scope="row"><strong><?php echo $row['fechapubli'] ?></strong></td>
                  ...
                  <?php else: ?>
                    <tr>
                          <td><strong>No se encontraron datos.</strong></td>
                          <td></td>
                          <td></td>
                          <td></td>
                          <td></td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-mb">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
              <form id="editForm" method="POST" enctype="multipart/form-data" action="../../Controller/noticiaController.php">
                <input type="text" id="edit-idnoticia" name="idnoticia" class="form-control" style="display: none;">
                <div class="mb-12">                  
                  <label for="edit-titulo" class="form-label">Título de la Noticia:</label>
                  <input type="text" id="edit-titulo" name="titulo" class="form-control">
                </div>
                <br/>
                <div class="mb-12">
                  <label for="edit-descripcion" class="form-label">Descripción de la Noticia:</label>
                  <textarea class="form-control" id="edit-descripcion" name="descripcion" style="height: 150px;"></textarea><br/>
                </div>
                <div class="mb-12">
                  <label for="edit-fecha" class="form-label">Fecha de Publicación:</label>
                ...
                <div class="mb-8">
                  <center>
                  <label for="current-foto" class="form-label">Foto de la Noticia</label>
                  <div id="current-foto" class="mb-2">
                    <img id="edit-foto" src="../../source/img/Noticia/<?php echo $row['foto']; ?>" alt="Foto de la Noticia" class="img-fluid">
                  </div>
                  </center>
                </div>                
              </form>
  ...
  <script>
      $(document).ready(function(){
        $('.editar-btn').click(function(){
          ...
          $('#edit-idnoticia').val(noticia.idnoticia);
          $("#edit-titulo").val(noticia.titulo);
          $('#edit-descripcion').val(noticia.descripcion);
          $('#edit-fecha').val(noticia.fechapubli);
          $('#edit-foto').attr('src', '../../source/img/Noticia/' + noticia.foto);
      ...
      $('.eliminar-btn').click(function(){
        ...
        var confirmarEliminar = confirm("¿Estás seguro de que deseas eliminar la noticia?");
        if(confirmarEliminar){
          $.ajax({
            url: "../../Controller/noticiaController.php",
            method: "POST",
            data: { accion: "eliminar", idnoticia: idnoticia},
