...
<head>
  ...
  <title>Redes Sociales - Personal</title>
  <!-- Favicons -->
          ...
          <div class="card">
            <div class="card-body">
              <form class="row g-3" action="../../Controller/redesController.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="accion" value="registraredpersonal">
                  ...
                  <?php if($redes): ?>
                    <?php foreach($redes as $row): ?>
                      <tr class="align-middle">
                        ...
                        <td scope="row"><img src="../../source/img/Red/<?php echo $row['imagen'] ?>" style="width: 100px; height:100px;" alt="Redes sociales"/></td>
                        <td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editForm" method="POST" enctype="multipart/form-data" action="../../Controller/redesController.php">
            ...
            <input type="hidden" name="accion" value="updateredpersonal">
            <div class="text-center">
