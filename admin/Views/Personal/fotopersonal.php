...
<body>
          ...
          <div class="card">
              <div class="card-body">
                  ...
                  <form class="row g-3" action="../../Controller/fotoController.php" method="POST" enctype="multipart/form-data">
                      ...
                      <input type="hidden" name="accion" value="registrarfotopersonal">
                        ...
                        <?php if($fotos): ?>
                          <?php foreach($fotos as $row): ?>
                            <tr class="align-middle">
                              ...
                              <td>
                                <button class="btn btn-secondary editar-btn-foto" data-foto='<?php echo json_encode($row); ?>'>Editar Foto</button><br/><br/>
                                <button class="btn btn-danger eliminar-btn-foto" data-idfoto='<?php echo $row['idfoto']; ?>'>Eliminar Foto</button>
                              </td>
                            </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
    ...
    <div class="modal-dialog modal-lg-4">
      <div class="modal-content">
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data" action="../../Controller/listaController.php">
            ...
            <input type="hidden" name="accion" value="updatefotopersonal">
            <div class="text-center">
  ...
  <script>
      ...
      $('.eliminar-btn-foto').click(function(){
        ...
        var confirmarEliminar = confirm("¿Estás seguro de que deseas eliminar la foto?");
