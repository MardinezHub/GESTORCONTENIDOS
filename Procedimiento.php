<?php
    ...
    $fotosPrincipal = $paginaModel->obtenerFotosPorPagina($paginaPrincipalId);
    $fotosSubpagina = $paginaModel->obtenerFotosPorSubpagina($subpaginaId);
?>
<!DOCTYPE html>
                            ...
                            <div class="col-md-12">
                                <div class="section-title mb-30">
										...
										<?php
											...
											elseif ($subpaginaId != 0 && $fotosSubpagina) 
											{
												foreach ($fotosSubpagina as $foto) {
													echo "<div class='text-center'>";
													echo "<img src='admin/source/img/Foto/{$foto['foto']}' alt='Foto'>";
													echo "</div>";
												}
